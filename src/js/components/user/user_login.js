	...
	render(){
		...
		return (
			<div className="content">
				...
				<form className="login-contain" onSubmit={(e) => this.submit(e)}>
					<div className="login-line">
						...
						<span style={nameShow} className="icon icon-clear" onClick={(e) => this.clearItem(e,'userName')}></span>
					</div>
					<div className="login-line">
						...
						<span style={pwdShow} className="icon icon-clear" onClick={(e) => this.clearItem(e,'userPwd')}></span>
					</div>
					...
					<div className="line-note">
						<Link to="" className="item-link">忘记密码</Link>   
